...
_AWARENESS_TIME = min(int(kegman.conf['wheelTouchSeconds']), 6000000)    # x minutes limit without user touching steering wheels make the car enter a terminal status
