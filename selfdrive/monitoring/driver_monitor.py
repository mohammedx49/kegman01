...
_AWARENESS_TIME = min(int(kegman.conf['wheelTouchSeconds']), 60000)    # x minutes limit without user touching steering wheels make the car enter a terminal status
