...
_AWARENESS_TIME = min(int(kegman.conf['wheelTouchSeconds']), 999999)    # x minutes limit without user touching steering wheels make the car enter a terminal status
_AWARENESS_PRE_TIME_TILL_TERMINAL = 99999.
