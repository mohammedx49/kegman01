...
_AWARENESS_TIME = min(int(kegman.conf['wheelTouchSeconds']), 9999999)    # x minutes limit without user touching steering wheels make the car enter a terminal status
